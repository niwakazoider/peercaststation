...
namespace PeerCastStation.Core
{
  ...
  public class OutputListener
  {
    ...
    /// <summary>
    /// PeerCastからの接続を許可するかどうかを取得および設定します。
    /// </summary>
    public bool PeerCastRelayable { get; set; }

    /// <summary>
    /// PeerCastStationからの接続を許可するかどうかを取得および設定します。
    /// </summary>
    ...
    private void OutputThreadFunc(object arg)
    {
      ...
      try {
        ...
        if (factory!=null) {
          ...
          access_control.SetPeerCastStationRelayable(PeerCastStationRelayable);
          access_control.SetPeerCastRelayable(PeerCastRelayable);
